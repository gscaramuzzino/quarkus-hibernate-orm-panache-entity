# Movie PanacheEntity - Quarkus Hibernate ORM

Quarkus Hibernate ORM PanacheEntity with PostgreSQL
...
You can then execute your native executable with: `./target/quarkus-hibernate-orm-panache-entity-1.0.0-SNAPSHOT-runner`
